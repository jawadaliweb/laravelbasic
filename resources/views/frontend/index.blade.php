...
@section('frontfront')
    <!-- banner-area -->
@include('frontend.home_slider.slider')
    <!-- banner-area-end -->
    ...
    <div class="col-lg-6">
        <ul class="about__icons__wrap">
            ...
            <li>
                <img class="light" src="{{asset('assets/img/icons/invision_light.png')}}" alt="Invision">
                <img class="dark" src="{{asset('assets/img/icons/invision.png')}}" alt="Invision">
            </li>
            <li>
        ...
        <div class="about__content">
            ...
            <div class="about__exp">
                <div class="about__exp__icon">
                    <img src="frontend/assets/img/icons/about_icon.png" alt="">
                </div>
